...
$(document).ready(function() {
	...
	$('#sidebar').addClass("bigside").delay(5000).queue(function(){
		$('#sidebar').removeClass("bigside");
	});
    $('#cke_main').addClass("smallmain").delay(5000).queue(function(){
		$('#cke_main').removeClass("smallmain");
	});
	$('.headtitle').addClass("movetitle").delay(5000).queue(function(){
		$('.headtitle').removeClass("movetitle");
	});
...
CKEDITOR.editorConfig = function (config) {
	...
	config.toolbar_personal = [
    	["Bold",  "Italic",  "Underline", "RemoveFormat", "Format", "JustifyLeft", "JustifyCenter", "JustifyRight", "JustifyBlock"],
  	];
